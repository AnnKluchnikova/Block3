...
int main()
{
	...
	char pathname[] = "server.c"; /* Имя файла, использующееся для генерации ключа. Файл с таким именем должен существовать в текущей директории */
	...
	if((msqid = msgget(key, 0666 | IPC_CREAT)) < 0) /*Доступ к очереди сообщений по ключу*/
	 {
